...
export { canvas, ctx, output, setUpdate, getWidth, getHeight, hideCursor, setBackgroundColor, setSize, showCursor, add, remove, removeAll, getElementAt, getElementsAt, println, readBoolean, readFloat, readInt, readLine, readLineConsole, readIntConsole, readFloatConsole, readBooleanConsole, Randomizer, Color, Keyboard, baseObj, Circle, Rectangle, Line, WebImage, Text, Arc, ArcMode, Oval, setTimer, stopTimer, stopAllTimers, mouseClickMethod, mouseMoveMethod, keyUpMethod, keyDownMethod, gcf, getPosition, lineDistance, rotatePoint, toDegrees, toRadians, };
